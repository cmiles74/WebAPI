...
namespace Nervestaple.WebApi.Controllers {
    ...
    /// </summary>
    public abstract class AbstractReadOnlyController<T, K> : EntityController, IReadOnlyController<T, K> 
        where T: IEntity<K>
        where K: struct {
        ...
        /// </summary>
        public AbstractReadOnlyController(IReadOnlyService<T, K> service) {
            Service = service;
        }
